...
namespace RealTimePatternRec.PatternRec
{
    ...
    public class AccordSVMGaussianModel:IPredictor
    {
        ...
        {
            Serializer.Save(learner, filename);
        }

        public void load(string filename)
        {
            Serializer.Load(filename, out learner);
        }
    }
    ...
    public class AccordLDAModel : IPredictor
    {
        ...
        public void save(string filepath)
        {
            ...
            Serializer.Save(learner, filepath);
        ...
        public void load(string filepath)
        {
            ...
            Serializer.Load(filepath, out learner);
        }
    }
    ...
    public static class Tests
    {
        public static void ONNXTest()
        {
            ...
            onnxmodel.load_onnx<float, float>(onnxfilepath, 8 * 33, 5, "input", "softmax");
        ...
        public static void ONNXSettingsTest()
        {
            ...
            string settings_filepath = @"C:\Users\Rico\OneDrive\Documents\School\BLINC\Project\Development\BrachIOplexus Classifier\Heather ONNX\generalized_classifier.json";
            string onnxfilepath = @"C:\Users\Rico\OneDrive\Documents\School\BLINC\Project\Development\BrachIOplexus Classifier\Heather ONNX\generalized_classifier.onnx";
